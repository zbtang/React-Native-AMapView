...
//            marker.setInfoWindowAnchor(calloutAnchorX, calloutAnchorY);
            marker.setAnchor(calloutAnchorX, calloutAnchorY);
        }
        update();
    }
...
//            marker.setInfoWindowAnchor(0.5f, 0);
    ...
    public View getCallout() {
        ...
        if (wrappedCalloutView.getParent() != null && wrappedCalloutView.getParent() instanceof ViewGroup)
            ((ViewGroup) wrappedCalloutView.getParent()).removeView(wrappedCalloutView);
    ...
    private void wrapCalloutView() {
        ...
        LL.setLayoutParams(new LinearLayout.LayoutParams(
                this.calloutView.width + dpToPx(10),
                this.calloutView.height + dpToPx(30),
                0f
        ));
        ...
        LL.addView(LL2);
        if (calloutView.getParent() != null && calloutView.getParent() instanceof ViewGroup)
            ((ViewGroup) calloutView.getParent()).removeView(calloutView);
